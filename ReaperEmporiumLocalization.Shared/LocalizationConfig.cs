...
namespace ReaperEmporiumLocalization.Shared
{
    ...
    {
        public static ConfigEntry<bool> EnableDllDump      { get; private set; }
        public static ConfigEntry<bool> EnableDatabaseDump { get; private set; }
        
        // 【关键修改】使用普通 string 替代 UnityEngine.KeyCode
        public static ConfigEntry<string> HotReloadKey { get; private set; }
